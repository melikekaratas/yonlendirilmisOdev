<%@ Page Language="C#" AutoEventWireup="true" CodeFile="sahiplendir.aspx.cs" Inherits="sahiplendir" %>
                        ...
                        <table style="width:100%;">
                            <tr>
                                <td class="auto-style5" colspan="4">
                                    <asp:FileUpload ID="fuResim" runat="server" Height="44px" Width="237px" />
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td class="auto-style7" colspan="2">
                                    <asp:Button ID="Button7" runat="server" BackColor="#F3D15E" ForeColor="White" Height="33px" OnClick="Button7_Click" Text="İlan Ver" Width="87px" />
                                </td>
                                <td>&nbsp;</td>
                            </tr>
                        </table>
